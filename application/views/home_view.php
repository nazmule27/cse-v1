...
<div class="container">
    <!--<div class="alert alert-success text-center hot-news">
        <div class="row">
            <div class="col-md-11"><marquee behavior="scroll" direction="left">Your scrolling text goes here</marquee></div>
            <div class="col-md-1"><a class="close" title="close" aria-label="close" data-dismiss="alert" href="#">×</a></div>
        </div>
    </div>-->

    <!-- Example row of columns padding-to-120 -->
    <div class="row">
        <div class="col-md-8">
                ...
                <div class="tab-content">
                    <div id="notice" class="tab-pane fade in active">
                        <div class="panel-body">
                            <?php $k=1; for ($i = 0; $i < count($notice); ++$i) {?>
                    ...
                    <div id="event" class="tab-pane fade">
                        <div class="panel-body">
                            <?php $k=1; for ($i = 0; $i < count($events); ++$i) {?>
