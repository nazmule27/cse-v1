        ...
        <div class="col-md-12 col-sm-12">
            ...
            <p>
                <b>&raquo; Research Fields:</b> <br>
                    <?php $k=1; for ($i = 0; $i < count($research_field); ++$i) {?>
                    &emsp;<a href="<?=base_url();?>research/string/<?php echo $research_field[$i]->research_area;?>"><?php echo $research_field[$i]->research_area;?></a> <br>
                    <?php $k++;} ?>
            </p>
            <p>
                <b>&raquo; Research Groups:</b> <br>
                <?php $k=1; for ($i = 0; $i < count($research_detail); ++$i) {?>
                    <p>&emsp;<?php echo $research_detail[$i]->research_group;?></p>
                <?php $k++;} ?>
            </p>
            <p>
                <b>&raquo; Related Faculties:</b> <br>
                <?php $k=1; for ($i = 0; $i < count($research_faculty); ++$i) {?>
            ...
            <p>
                <b>&raquo; Related Links:</b> <br>
                    <?php if (isset($research_detail[0]->research_ext_link1)) {
                        echo '<a href="'.$research_detail[0]->research_ext_link1.'">'.$research_detail[0]->research_ext_link1.'</a>';
                    }
                    ?>
                    <?php if (isset($research_detail[0]->research_ext_link2)) {
                        echo '<a href="'.$research_detail[0]->research_ext_link2.'">'.$research_detail[0]->research_ext_link2.'</a>';
                    }
                    ?>
                    <?php if (isset($research_detail[0]->research_ext_link3)) {
                        echo '<a href="'.$research_detail[0]->research_ext_link3.'">'.$research_detail[0]->research_ext_link3.'</a>';
                    }
                    ?>
            </p>
            <p>
